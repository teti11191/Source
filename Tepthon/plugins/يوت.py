...
# تم تعديل دالة الكوكيز لتعطيلها مؤقتاً
def get_cookies_file():
    return None  # تم التعليق على استخدام الكوكيز العشوائية
...
video_opts = {
    ...
    "prefer_ffmpeg": False,
    "geo_bypass": True,
    "geo_bypass_country": "US",  # إضافة تجاوز الجغرافي
    "outtmpl": "zed_ytv.mp4",
    "merge_output_format": "mp4",
    "quiet": True,
    "no_warnings": True,
    # "cookiefile": get_cookies_file(),  # تم التعليق على هذا السطر
}

# تم تحسين دالة تحميل اليوتيوب
...
ZelzalMeMe_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗭𝗧𝗵𝗼𝗻 - اوامـر البصمـات 🎙](t.me/ZedThon/9) 𓆪\n\n"
