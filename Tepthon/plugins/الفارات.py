...
""" وصـف الملـف : أوامر إضـافة الفـارات باللغـة العربيـة كـاملة ولا حـرف انكلـش🤘 تخمـط اذكـر المصـدر يولـد
...
BaqirVP_cmd = (
    "𓆩 [ 𝗧𝗲𝗽𝘁𝗵𝗼𝗻 𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀 - أوامر الفـارات](t.me/Tepthon) 𓆪\n\n"
    ...
    "⪼ قنـاة كلايـش الفحـص @tepthonklaesh\n\n"
    ...
    "⪼ `.اضف كليشة الايدي` بالـرد على الكليشـه مـن القنـاة @tepthonklaesh\n\n\n"
...
BaqirTZ_cmd = (
    "𓆩 [𝗧𝗲𝗽𝘁𝗵𝗼𝗻 𝗖𝗼𝗻𝗳𝗶𝗴 - أوامر الوقت](t.me/Tepthon) 𓆪\n\n"
...
async def custom_rep(event):
    ...
    if (input_str == "كليشة الحماية" or input_str == "كليشة الحمايه" or input_str == "كليشه الحماية" or input_str == "كليشه الحمايه"):
        ...
        if variable is None:
            await zed.edit("**⎉╎فـار ايموجي/رمز الايدي غيـر موجـود ❌**\n**⎉╎لـ إضـافته بالـرد على الكليشـة من هنا ( @tepthonklaesh ) استخـدم الأمـر : ↶**\n `.اضف كليشة الايدي` \n\n**⎉╎قنـاة السـورس : @Tepthon**")
        else:
            await zed.edit("**⎉╎الفـار {} موجـود ☑️**\n**⎉╎قيمـة الفـار : ↶**\n `{}` \n\n**⎉╎قنـاة السـورس : @Tepthon**".format(input_str, variable))
